...
class ChatMessageService:
    ...
    async def save_user_message(
        ...
        """
        Saves a new user message in the specified chat session asynchronously.
        ...
        """
        try:
            stmt = select(UserChat).filter(UserChat.chat_id == chat_id).with_for_update()
    ...
    async def create_assistant_placeholder(
        ...
        """
        Creates an initial assistant message placeholder with PENDING status asynchronously.
    ...
    async def get_message_by_id(
        ...
        """
        Retrieves a single message by ID asynchronously.
    ...
    async def update_message_status(
        ...
        """
        Updates the execution lifecycle status of a message asynchronously.
        ...
        try:
            ...
            message.updated_at = datetime.now(timezone.utc).replace(tzinfo=None)  # pyright: ignore [reportAttributeAccessIssue]
    ...
    async def fail_assistant_message(
        ...
        """
        Marks an assistant response as FAILED, preserving any partial content and recording error details asynchronously.
    ...
    async def load_chat_messages(
        ...
        """
        Loads paginated messages for a chat thread ordered by sequence number ascending asynchronously.
    ...
    async def get_recent_messages(
        ...
        """
        Retrieves the N most recent messages for a chat, returned in chronological order for AI context building asynchronously.
