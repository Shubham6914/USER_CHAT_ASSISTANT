        ...
        <div className="glass-panel rounded-2xl shadow-xl shadow-slate-100/50 dark:shadow-none p-8 border border-slate-200/50 dark:border-zinc-800/50">
          ...
          <div className="mb-5">
            <button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-xl border border-slate-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 text-slate-700 dark:text-zinc-200 font-semibold text-sm hover:bg-slate-50 dark:hover:bg-zinc-800/80 transition-all duration-200 shadow-sm cursor-pointer disabled:opacity-50"
            >
